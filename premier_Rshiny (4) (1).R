...
ui <- navbarPage(
  ...
  tabPanel("Carte Interactive", 
           ...
           sidebarPanel(selectInput("logements_69_final", "Filter by DPE Etiquette:",
                                    choices = unique(logements_69_final$Etiquette_DPE),
                                    selected = NULL,
                                    multiple = TRUE)),
           mainPanel(
...
logements_69_final=read.csv2("logements_69_final.csv",sep = ",")
logements_69_final$lon=as.numeric(logements_69_final$lon)
logements_69_final$lat=as.numeric(logements_69_final$lat)
